            ...
            <div className="card card-sm">
                ...
                <form onSubmit={handleRegister}>
                    <div className="form-group">
                        ...
                        <input className="form-input" placeholder="Choose a username" value={username}
                    ...
                    <div className="form-group">
                        ...
                        <input className="form-input" type="password" placeholder="Repeat password" value={confirm}
